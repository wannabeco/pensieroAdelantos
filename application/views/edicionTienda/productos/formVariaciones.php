<form role="form" enctype="multipart/form-data"  ng-controller="gestionTienda" ng-init="initVariaciones()" id="formulario" ng-submit="procesaVariaciones()">    
  <div class="modal-header">
      ...
      <p class="text-justify">
        Crea o modifica las variaciones para el producto <?php echo $infoProducto['nombrePresentacion']?>
      </p>
  </div>
               ...
               <div class="row variacionesList" data-idvariacion="<?php echo $datos['idVariacion']?>" data-nueva="0" id="panelVariacion<?php echo $datos['idVariacion']?>">
                  ...
                  <div class="col col-lg-12 col-md-12">
                      <div class="form-group  label-floating">
                          <label class="control-label" for="nombreVariacion">Nombre variación</label>
                   ...
                   <div class="col col-lg-4 col-md-4">
                      <div class="form-group  label-floating">
                          <label class="control-label" for="valorPresentacion">Valor *</label>
  ...
  <div class="modal-footer">
    ...
    <?php if(getPrivilegios()[0]['crear'] == 1 && $edita == 0){ ?>
      <button type="button" ng-click="agregarVariacion()" class="btn btn-raised btn-info">AGREGAR VARIACIÓN</button>
    <?php } ?>
    <?php if(getPrivilegios()[0]['crear'] == 1 && $edita == 0){ ?>
