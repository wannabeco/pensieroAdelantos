...
<div ng-controller="empresas" ng-init="empresasInit()" id="contenedorEmpresas">
            ...
            <?php if(getPrivilegios()[0]['crear'] == 1){ ?>
                <div class="btn-group" >
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="btn" href="<?php echo base_url()?>Empresas/gestionEmpresas/<?php echo $infoModulo['idModulo'] ?>/crear/0"><i class="fa fa-fw fa-plus"></i>  NUEVA EMPRESA</a></li>
                    </ul>
                </div>
            <?php } ?>
        </h1>
                ...
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped jambo_table bulk_action">
                            ...
                            <tbody>
                                <tr ng-repeat="ulist in empresas  | filter:q as results">
                                    ...
                                    <td  class="text-center">
                                        ...
                                        <?php if(getPrivilegios()[0]['borrar'] == 1){ ?>
                                            <a ng-click="borrarEmpresa(ulist.idEmpresa)" title="Eliminar"  class="btn btn-danger btn-fab btn-fab-mini btn-xs text-white"><i class="fa fa-trash"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            </tbody>
