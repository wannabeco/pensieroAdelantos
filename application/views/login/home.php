          ...
          <section class="login_content">
            ...
            <form class="form-signin" data-ember-action="2" id="formLogin" ng-submit="loginInApp()">
              ...
              <button class="btn btn-danger " href="index.html"><?php echo lang("labelBtnLogin") ?></button>
                ...
                <a class="reset_pass text-danger" href="#signup">Olvid&oacute; su clave?</a>
              </div>
        ...
        <div id="register" class="animate form registration_form">
          ...
          <img src="<?php echo base_url()?>res/img/logo.png?<?php echo rand(0,1000)?>" alt="" width="80%">
            <form id="formCambioClave" ng-submit="recordarClaveUsuario()">
              ...
              <div>
                <button class="btn btn-danger " href="index.html">Enviar nueva clave</button>
              </div>
              ...
              <div class="separator">
                <p class="change_link">
                  <a href="#signin" class="to_register text-danger"> <i class="fa fa-arrow-left"></i> Regresar </a>
                </p>
