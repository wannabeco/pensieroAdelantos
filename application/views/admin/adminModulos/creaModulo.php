<form role="form"  ng-controller="modulosProcesador" id="formAgregaModulo" ng-submit="procesaModulos(<?php echo $edita ?>)">    
  ...
  <div class="modal-body">        
    ...
    <div class="form-group">
      <input tabindex="1" autocomplete="off" id="nombreLargo" name="nombreLargo"  class="ember-view ember-text-field form-control login-input" value="<?php echo (isset($datos['nombreLargo']))?$datos['nombreLargo']:''; ?>" placeholder="Escriba completo del módulo"  type="text">
      <p class="help-block">Nombre completo del módulo</p>
    </div>        
    <div class="form-group">
    ...
    <div class="form-group">
      <input tabindex="1" autocomplete="off" id="iconoApp" name="iconoApp"  class="ember-view ember-text-field form-control login-input" value="<?php echo (isset($datos['icono']))?$datos['icono']:''; ?>" placeholder="Icono de la librer&iacute;a Fonawesome ej: fa fa-file"  type="text">
      <p class="help-block">Agregue el de la librería fontawesome. Ej: fa fa-file</p>
    </div> 
    <?php if($edita == 1){ ?>
    <div class="form-group">
