        ...
        <div class="modal-content">
            <form role="form" ng-submit="agregarCategoria()" id="formAgregaPersona">    
                ...
                <div class="modal-body">  
                    ...
                    <div class="form-group" id="cajaNombreEmpresa">
                        <input tabindex="1" autocomplete="off" id="icono" name="icono" ng-model="icono" class="ember-view ember-text-field form-control login-input" placeholder="Ícono de la categoría. Fontawesome Ej: fa fa-file"  type="text">
