...
class Admin extends CI_Controller 
{
	...
	public function consultarPrivilegios($idModulo)
    {
    	...
    	// Consultar los privilegios para el módulo
		$this->privilegios = current( getPrivilegios() );
	}
    ...
    */
	public function adminModulos($idModulo)	
	{
		...
		if(validaIngreso())
		{
			...
			/*******************************************************************************************/
			// Primero consultar los permisos sobre el modulo
			$this->consultarPrivilegios($idModulo);
			...
			{ 
				...
				$salida['privilegios'] = $this->privilegios;
