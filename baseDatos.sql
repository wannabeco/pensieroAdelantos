...
--
-- Host: localhost    Database: acdacpagos
-- ------------------------------------------------------
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`pensieroAdelantos` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `pensieroAdelantos`;
...
--
-- Dumping data for table `app_areas`
--

LOCK TABLES `app_areas` WRITE;
/*!40000 ALTER TABLE `app_areas` DISABLE KEYS */;
INSERT INTO `app_areas` VALUES (1,'Sistemas',1);
/*!40000 ALTER TABLE `app_areas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_auditoria_general`
--

LOCK TABLES `app_auditoria_general` WRITE;
/*!40000 ALTER TABLE `app_auditoria_general` DISABLE KEYS */;
INSERT INTO `app_auditoria_general` VALUES (1,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2017-02-14 11:06:51','192.168.0.33',1),(2,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2017-02-14 14:03:53','192.168.0.33',1),(3,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2017-02-14 14:04:00','192.168.0.33',1),(4,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2017-02-14 14:04:22','192.168.0.33',1),(5,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2017-02-14 14:04:27','192.168.0.33',1),(6,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2017-02-14 14:05:07','192.168.0.33',1),(7,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2017-02-14 16:47:52','192.168.0.33',1),(8,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2018-09-26 10:43:56','::1',1),(9,'CREACIONMODULO','Se ha creado el módulo Parametrización | 35',1,'2018-09-26 10:47:43','::1',1),(10,'PRIVILEGIOSMODULOS','Se actualizaron los provilegios del módulo: ver=1, crear=1, editar=1, borrar=1 para el perfil=1 | 35',1,'2018-09-26 10:47:44','::1',1),(11,'PRIVILEGIOSMODULOS','Se actualizaron los provilegios del módulo: ver=0, crear=0, editar=0, borrar=0 para el perfil=2 | 35',1,'2018-09-26 10:47:44','::1',1),(12,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2019-05-18 09:00:28','127.0.0.1',1),(13,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2019-05-18 09:44:24','127.0.0.1',1),(14,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2019-05-18 09:44:44','127.0.0.1',1),(15,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2019-05-18 10:42:00','127.0.0.1',1),(16,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2019-05-18 10:42:03','127.0.0.1',1),(17,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2019-05-18 10:51:28','127.0.0.1',1),(18,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2019-05-18 10:51:34','127.0.0.1',1),(19,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2019-05-18 11:54:26','127.0.0.1',1),(20,'INICIODESESION','Ha ingresado al sistema el usuario Farez Prieto | 1',1,'2019-05-18 10:55:17','127.0.0.1',1),(21,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2019-05-18 10:55:28','127.0.0.1',1),(22,'BORRADOPERSONA','Se ha borrado la información de la persona | 7',1,'2019-05-18 11:56:40','127.0.0.1',1),(23,'CIERREDESESION','Ha salido del sistema el usuario Farez Prieto | 1',1,'2019-05-18 11:59:30','127.0.0.1',1),(24,'INICIODESESION','Ha ingresado al sistema el usuario Administrador Principal | 1',1,'2019-05-18 11:59:35','127.0.0.1',1),(25,'CIERREDESESION','Ha salido del sistema el usuario Administrador Principal | 1',1,'2019-05-18 12:00:15','127.0.0.1',1),(26,'INICIODESESION','Ha ingresado al sistema el usuario Administrador Principal | 1',1,'2019-05-18 12:07:13','127.0.0.1',1),(27,'CIERREDESESION','Ha salido del sistema el usuario Administrador Principal | 1',1,'2019-05-18 12:10:37','127.0.0.1',1),(28,'INICIODESESION','Ha ingresado al sistema el usuario Administrador Principal | 1',1,'2019-05-18 12:10:44','127.0.0.1',1),(29,'CIERREDESESION','Ha salido del sistema el usuario Administrador Principal | 1',1,'2019-05-18 12:16:33','127.0.0.1',1),(30,'INICIODESESION','Ha ingresado al sistema el usuario Administrador Principal | 1',1,'2019-05-18 12:16:40','127.0.0.1',1),(31,'CIERREDESESION','Ha salido del sistema el usuario Administrador Principal | 1',1,'2019-05-18 13:30:11','127.0.0.1',1),(32,'INICIODESESION','Ha ingresado al sistema el usuario Administrador Principal | 1',1,'2019-05-18 13:30:15','127.0.0.1',1),(33,'CIERREDESESION','Ha salido del sistema el usuario Administrador Principal | 1',1,'2019-05-18 13:49:54','127.0.0.1',1),(34,'INICIODESESION','Ha ingresado al sistema el usuario Administrador Principal | 1',1,'2019-05-18 13:49:59','127.0.0.1',1);
/*!40000 ALTER TABLE `app_auditoria_general` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_cargos`
--

LOCK TABLES `app_cargos` WRITE;
/*!40000 ALTER TABLE `app_cargos` DISABLE KEYS */;
INSERT INTO `app_cargos` VALUES (1,'T?®cnico en sistemas',0,1);
/*!40000 ALTER TABLE `app_cargos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_cesantias`
--

LOCK TABLES `app_cesantias` WRITE;
/*!40000 ALTER TABLE `app_cesantias` DISABLE KEYS */;
INSERT INTO `app_cesantias` VALUES (1,'Porvenir',1),(2,'Proteccion',1),(3,'Bbva horizonte',1),(4,'Colfondos',1),(5,'Prestaciones sociales del Magisterio',1),(6,'Fondo Nacional del ahorro',1),(7,'Santander',1),(8,'Skandia',1);
/*!40000 ALTER TABLE `app_cesantias` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_estadopago`
--

LOCK TABLES `app_estadopago` WRITE;
/*!40000 ALTER TABLE `app_estadopago` DISABLE KEYS */;
INSERT INTO `app_estadopago` VALUES (1,1,1,'Demo Inicial de 90 d?¡as para que pruebes la aplicaci??n.','2016-06-29 10:58:04','2016-09-27 10:58:04',360,1,0),(2,2,1,'pago','2016-06-29 11:01:04','2016-09-27 11:01:04',90,1,0),(3,3,1,'Demo Inicial de 90 d?¡as para que pruebes la aplicaci??n.','2016-06-29 11:02:22','2016-09-27 11:02:22',90,1,0),(4,4,1,'Demo Inicial de 90 d?¡as para que pruebes la aplicaci??n.','2016-06-29 12:28:37','2016-09-27 12:28:37',90,1,0),(5,5,1,'Demo Inicial de 90 d?¡as para que pruebes la aplicaci??n.','2016-06-29 13:15:51','2016-09-27 13:15:51',90,1,0),(6,6,1,'Demo Inicial de 90 d?¡as para que pruebes la aplicaci??n.','2016-06-29 13:32:12','2016-09-27 13:32:12',90,1,0);
/*!40000 ALTER TABLE `app_estadopago` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `app_estados` VALUES (0,'Inactivo'),(1,'Activo');
...
--
-- Dumping data for table `app_listado_afp`
--

LOCK TABLES `app_listado_afp` WRITE;
/*!40000 ALTER TABLE `app_listado_afp` DISABLE KEYS */;
INSERT INTO `app_listado_afp` VALUES (1,'Colpensiones',1),(2,'Porvenir',1),(3,'Proteccion',1),(4,'Colfondos',1),(5,'Fondo de solidaridad pensional',1),(6,'Caja de prevision Social de los trabajadores de la universidad del Cauca',1),(7,'Caja Nacional de prevision Social ',1),(8,'Pensiones de Antioquia',1),(9,'Caja de prevision social de comunicaciones',1),(10,'Fondo de prevision social del Congreso de la Republica ',1),(11,'Asociacion Colombiana de Aviadores',1),(12,'Instituto de seguros Sociales para pensiones ',1),(13,'Instituto de seguros sociales para profesionales ',1),(14,'Skandia alternativo',1),(15,'Skandia administradora de fondos de pensiones y cesantias ',1),(16,'Santander',1),(17,'Bbva',1);
/*!40000 ALTER TABLE `app_listado_afp` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_listas`
--

LOCK TABLES `app_listas` WRITE;
/*!40000 ALTER TABLE `app_listas` DISABLE KEYS */;
/*!40000 ALTER TABLE `app_listas` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `app_login` VALUES (7,1,2,'admin@wannabe.dev','8cb2237d0679ca88db6464eac60da96345513964','MTAzMDUzNDg0OQ==',0,1,0,1);
...
--
-- Dumping data for table `app_modulos`
--

LOCK TABLES `app_modulos` WRITE;
/*!40000 ALTER TABLE `app_modulos` DISABLE KEYS */;
INSERT INTO `app_modulos` VALUES (1,0,'CONFIGURACIÓN','fa-cog',NULL,1,0),(3,1,'Admin módulos',NULL,'Admin/adminModulos/',1,0),(4,1,'Listados generales','fa-list-alt','adminListas/listadosGlobales/',1,0),(5,1,'Usuarios','fa-user','Usuarios/adminUsuarios/',1,0),(34,1,'Admin pacientes',NULL,'Pacientes/AdminPacientes/CE/',1,1),(35,1,'Parametrización',NULL,'Parametrizacion/parametrizacion/',1,0);
/*!40000 ALTER TABLE `app_modulos` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `app_paises` VALUES ('057','COLOMBIA'),('058','VENEZUELA');
...
--
-- Dumping data for table `app_perfiles`
--

LOCK TABLES `app_perfiles` WRITE;
/*!40000 ALTER TABLE `app_perfiles` DISABLE KEYS */;
INSERT INTO `app_perfiles` VALUES (1,'Súper Administrador',1,0),(2,'Administrador',1,0);
/*!40000 ALTER TABLE `app_perfiles` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_personas`
--

LOCK TABLES `app_personas` WRITE;
/*!40000 ALTER TABLE `app_personas` DISABLE KEYS */;
INSERT INTO `app_personas` VALUES (1,1,'Administrador','Principal','Cra 100 # 69 48','7203015','3114881738',1,11,NULL,4,1030534849,'55555',1,'$3.000.000','BTA4568',1,1,'T?®cnico profesional en desarrollo de sotware',1,'11-001','1987-03-02 00:00:00','INDEFINIDO','2016-11-24','icono.png','Bosa Recreo',NULL,'Cedinpro',NULL,26,4,2,'5c8da074316baa0a9c7b7edfd45b011f.jpg','admin@wannabe.dev',NULL,1,0);
/*!40000 ALTER TABLE `app_personas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_pertenencia_etnica`
--

LOCK TABLES `app_pertenencia_etnica` WRITE;
/*!40000 ALTER TABLE `app_pertenencia_etnica` DISABLE KEYS */;
INSERT INTO `app_pertenencia_etnica` VALUES (1,'Ind?¡gena',1),(2,'ROM (gitano)',1),(3,'Raizal (archipi?®lago de San Andr?®s y Providencia)',1),(4,'Palanquero de San Basilio',1),(5,'Negro(a), Mulato(a), Afrocolombiano(a) o Afro descendiente',1),(6,'Ninguno de los anteriores',1);
/*!40000 ALTER TABLE `app_pertenencia_etnica` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_profesiones`
--

LOCK TABLES `app_profesiones` WRITE;
/*!40000 ALTER TABLE `app_profesiones` DISABLE KEYS */;
INSERT INTO `app_profesiones` VALUES (1,'Ing de Sistemas',1);
/*!40000 ALTER TABLE `app_profesiones` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_registroslogin`
--

LOCK TABLES `app_registroslogin` WRITE;
/*!40000 ALTER TABLE `app_registroslogin` DISABLE KEYS */;
INSERT INTO `app_registroslogin` VALUES (240,7,'2017-02-14 11:06:51','192.168.0.33','Mozilla/5.0 (Windows NT 10.0; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0',0),(241,7,'2017-02-14 14:04:00','192.168.0.33','Mozilla/5.0 (Windows NT 10.0; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0',0),(242,7,'2017-02-14 14:04:27','192.168.0.33','Mozilla/5.0 (Windows NT 10.0; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0',0),(243,7,'2017-02-14 16:47:52','192.168.0.33','Mozilla/5.0 (Windows NT 10.0; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0',0),(244,7,'2018-09-26 10:43:56','::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36',0),(245,7,'2019-05-18 09:00:28','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(246,7,'2019-05-18 09:44:24','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(247,7,'2019-05-18 10:42:00','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(248,7,'2019-05-18 10:51:28','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(249,7,'2019-05-18 11:54:26','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(250,7,'2019-05-18 10:55:17','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(251,7,'2019-05-18 11:59:35','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(252,7,'2019-05-18 12:07:13','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(253,7,'2019-05-18 12:10:44','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(254,7,'2019-05-18 12:16:40','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(255,7,'2019-05-18 13:30:15','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0),(256,7,'2019-05-18 13:49:59','127.0.0.1','Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.96 Safari/537.36',0);
/*!40000 ALTER TABLE `app_registroslogin` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `app_rel_perfil_modulo` (
  `idRelaci├│nPM` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`idRelaci├│nPM`)
) ENGINE=InnoDB AUTO_INCREMENT=381 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `app_rel_perfil_modulo`
--

LOCK TABLES `app_rel_perfil_modulo` WRITE;
/*!40000 ALTER TABLE `app_rel_perfil_modulo` DISABLE KEYS */;
INSERT INTO `app_rel_perfil_modulo` VALUES (119,1,7,0,0,0,0),(120,2,7,0,0,0,0),(173,1,3,1,1,1,1),(174,2,3,1,1,1,0),(194,1,6,1,1,1,1),(195,2,6,1,1,1,0),(197,1,33,1,1,1,1),(198,2,33,1,1,1,0),(200,1,35,1,1,1,1),(201,2,35,1,1,1,0),(209,1,4,1,1,1,1),(210,2,4,1,1,1,0),(248,1,37,1,1,1,1),(249,2,37,1,1,1,1),(254,1,38,1,1,1,1),(255,2,38,1,1,1,0),(263,1,41,1,1,1,1),(265,2,41,1,1,1,0),(267,1,39,1,1,1,1),(268,2,39,1,1,1,1),(287,1,34,1,1,1,1),(290,2,34,1,1,1,1),(349,1,42,1,1,1,1),(353,2,42,1,1,1,1),(356,1,44,1,1,1,1),(358,2,44,1,1,1,0),(370,1,5,1,1,1,1),(373,2,5,1,1,1,1),(377,1,43,1,1,1,1),(378,2,43,0,0,0,0),(379,1,35,1,1,1,1),(380,2,35,0,0,0,0);
/*!40000 ALTER TABLE `app_rel_perfil_modulo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_rel_personas_empresa`
--

LOCK TABLES `app_rel_personas_empresa` WRITE;
/*!40000 ALTER TABLE `app_rel_personas_empresa` DISABLE KEYS */;
/*!40000 ALTER TABLE `app_rel_personas_empresa` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_sexo`
--

LOCK TABLES `app_sexo` WRITE;
/*!40000 ALTER TABLE `app_sexo` DISABLE KEYS */;
INSERT INTO `app_sexo` VALUES (1,'Masculino',1),(2,'Femenino',1);
/*!40000 ALTER TABLE `app_sexo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_tipos_doc`
--

LOCK TABLES `app_tipos_doc` WRITE;
/*!40000 ALTER TABLE `app_tipos_doc` DISABLE KEYS */;
INSERT INTO `app_tipos_doc` VALUES (1,'Registro Civil','RC',1),(2,'Tarjeta De Identidad','TI',1),(3,'Pasaporte','PA',1),(4,'Cédula De Ciudadanía','CC',1),(5,'Cédula De Extranjería','CE',1),(6,'Menor Sin Identificación','MS',1),(7,'Adulto Sin Identificación','AS',1),(8,'Certificado Nacido Vivo','NV',1);
/*!40000 ALTER TABLE `app_tipos_doc` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `app_variablesglobales`
--

LOCK TABLES `app_variablesglobales` WRITE;
/*!40000 ALTER TABLE `app_variablesglobales` DISABLE KEYS */;
INSERT INTO `app_variablesglobales` VALUES (1,'Test','10');
/*!40000 ALTER TABLE `app_variablesglobales` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `aud_areas`
--

LOCK TABLES `aud_areas` WRITE;
/*!40000 ALTER TABLE `aud_areas` DISABLE KEYS */;
/*!40000 ALTER TABLE `aud_areas` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-05-18 13:03:52
