...
--
-- Servidor: localhost
-- Tiempo de generación: 07-08-2020 a las 03:41:05
...
INSERT INTO `app_empleados` (`idEmpleado`, `idEmpresa`, `codigoVerificacion`, `caducidadCodigo`, `nombres`, `apellidos`, `cargo`, `tipoDocumento`, `nroDocumento`, `direccion`, `genero`, `telefono`, `email`, `salario`, `ultimoIngreso`, `estado`, `eliminado`) VALUES
(1, 7, '0226', '2020-08-06 09:50:42', 'Javier Giovanny', 'Neuta Triviño', 'Ingeniero de desarrollo', 4, '1030534849', 'Bogota', 1, 2147483647, 'desarrollo@wannabe.com.co', 3000000, NULL, 1, 0),
(2, 5, NULL, NULL, 'Viviana', 'Sogamoso', 'Admnistrativa', 4, '123456789', 'Barranquilla', 2, 2147483647, 'vsogamoso@pensiero.com.co', 2000000, NULL, 1, 0),
(3, 7, NULL, NULL, 'Marcel', 'Gomez', 'Ingeniero de desarrollo', 4, '123456987', 'Calle 12345', 1, 356699879, 'mgomez@wannabe.com.co', 1800000, NULL, 1, 0),
(6, 7, NULL, NULL, 'Sandra Marcela', 'Ramirez', 'Jefe de unidad', 4, '1234567899', 'calle 27 # 20 20', 2, 2147483647, 'leshleedayhane@gmail.com', 3000000, NULL, 1, 0),
(7, 7, NULL, NULL, 'Jhon', 'Puerto', 'Programador', 4, '12345678999', 'calle 27 # 20 20', 1, 312566988, 'jhonato@gmail.com', 2500000, NULL, 1, 0),
(8, 7, NULL, NULL, 'Giovanny', 'Neuta', 'Programador', 4, '4558990009', 'calle 27 # 20 20', 1, 2147483647, 'gjneutat@gmail.com', 1500000, NULL, 1, 0),
(9, 7, NULL, NULL, NULL, NULL, NULL, 11, NULL, NULL, 11, NULL, NULL, NULL, NULL, 0, 1);
...
--
ALTER TABLE `app_auditoria_general`
  MODIFY `idAuditoria` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
...
--
ALTER TABLE `app_modulos`
  MODIFY `idModulo` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `app_registroslogin`
  MODIFY `idRegistro` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=304;

--
-- AUTO_INCREMENT de la tabla `app_rel_perfil_modulo`
--
ALTER TABLE `app_rel_perfil_modulo`
  MODIFY `idRelacion` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=465;
