...
# Tiempo de Generaci�n: 2020-08-11 23:45:16 +0000
# ************************************************************
...
INSERT INTO `app_areas` (`idArea`, `nombreArea`, `estado`)
VALUES
	(1,'Sistemas',1);
...
# Volcado de tabla app_auditoria_general
# ------------------------------------------------------------
...
INSERT INTO `app_auditoria_general` (`idAuditoria`, `tipoAuditoria`, `textAuditoria`, `idUsuario`, `fecha`, `ip`, `estado`)
VALUES
...
# Volcado de tabla app_bancos
# ------------------------------------------------------------

DROP TABLE IF EXISTS `app_bancos`;

CREATE TABLE `app_bancos` (
  `idEntidad` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
  `nombreEntidad` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`idEntidad`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `app_bancos` WRITE;
/*!40000 ALTER TABLE `app_bancos` DISABLE KEYS */;

INSERT INTO `app_bancos` (`idEntidad`, `nombreEntidad`)
VALUES
	(1,'Banco de Bogotá'),
	(2,'Bancolombia'),
	(3,'Davivienda'),
...
/*!40000 ALTER TABLE `app_bancos` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla app_cargos
# ------------------------------------------------------------
...
INSERT INTO `app_cargos` (`idCargo`, `nombreCargo`, `especialista`, `estado`)
VALUES
...
# Volcado de tabla app_cesantias
# ------------------------------------------------------------
...
INSERT INTO `app_cesantias` (`id_app_cesantias`, `nombrefondocesantias`, `estado`)
VALUES
	(1,'Porvenir',1),
	(2,'Proteccion',1),
	(3,'Bbva horizonte',1),
...
INSERT INTO `app_citas` (`idCita`, `idServicio`, `idEspecialista`, `idPaciente`, `fechaCita`, `horaCita`, `fechaFinCita`, `horaFinCita`, `usuarioCrea`, `fechaCrea`, `ip`, `tomada`, `observaciones`, `estado`, `eliminado`)
VALUES
...
INSERT INTO `app_ciudades` (`ID_PAIS`, `ID_DPTO`, `ID_CIUDAD`, `NOMBRE`, `estado`)
VALUES
...
# Volcado de tabla app_departamentos
# ------------------------------------------------------------
...
INSERT INTO `app_departamentos` (`ID_PAIS`, `ID_DPTO`, `NOMBRE`, `estado`)
VALUES
	('057','05','Antioquia',1),
	('057','08','Atlantico',1),
...
# Volcado de tabla app_empleados
# ------------------------------------------------------------
...
INSERT INTO `app_empleados` (`idEmpleado`, `idEmpresa`, `codigoVerificacion`, `caducidadCodigo`, `nombres`, `apellidos`, `cargo`, `tipoDocumento`, `nroDocumento`, `direccion`, `genero`, `telefono`, `email`, `clave`, `clave64`, `salario`, `ultimoIngreso`, `estado`, `eliminado`)
VALUES
	(1,7,'3450','2020-08-11 07:24:14','Javier Giovanny','Neuta Triviño','Ingeniero de desarrollo',4,'1030534849','Bogota',1,2147483647,'desarrollo@wannabe.com.co',NULL,NULL,3000000,NULL,1,0),
	(2,5,'4555','2020-08-11 18:41:27','Viviana','Sogamoso','Admnistrativa',4,'123456789','Barranquilla',2,2147483647,'vsogamoso@pensiero.com.co',NULL,NULL,2000000,NULL,1,0),
	(3,7,NULL,NULL,'Marcel','Gomez','Ingeniero de desarrollo',4,'123456987','Calle 12345',1,356699879,'mgomez@wannabe.com.co',NULL,NULL,1800000,NULL,1,0),
	(6,7,NULL,NULL,'Sandra Marcela','Ramirez','Jefe de unidad',4,'1234567899','calle 27 # 20 20',2,2147483647,'leshleedayhane@gmail.com',NULL,NULL,3000000,NULL,1,0),
	(7,7,NULL,NULL,'Jhon','Puerto','Programador',4,'12345678999','calle 27 # 20 20',1,312566988,'jhonato@gmail.com',NULL,NULL,2500000,NULL,1,0),
	(8,7,NULL,NULL,'Giovanny','Neuta','Programador',4,'4558990009','calle 27 # 20 20',1,2147483647,'gjneutat@gmail.com',NULL,NULL,1500000,NULL,1,0),
	(9,7,NULL,NULL,NULL,NULL,NULL,11,NULL,NULL,11,NULL,NULL,NULL,NULL,NULL,NULL,0,1);

/*!40000 ALTER TABLE `app_empleados` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla app_empresas
# ------------------------------------------------------------
...
INSERT INTO `app_empresas` (`idEmpresa`, `nombre`, `direccion`, `telefono`, `celular`, `ciudad`, `departamento`, `pais`, `tipoDocumento`, `nroDocumento`, `tipoActividad`, `logo`, `icono`, `nombreEncargado`, `email`, `ultimoIngreso`, `estado`, `eliminado`)
VALUES
...
# Volcado de tabla app_estadopago
# ------------------------------------------------------------
...
INSERT INTO `app_estadopago` (`idPago`, `idEmpresa`, `esDemo`, `descripcion`, `fechaInicio`, `fechaFin`, `cantComprada`, `estado`, `eliminado`)
VALUES
...
INSERT INTO `app_estados` (`idEstado`, `nombreEstado`)
VALUES
	(0,'Inactivo'),
	(1,'Activo');
...
# Volcado de tabla app_faqs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `app_faqs`;

CREATE TABLE `app_faqs` (
  `idFac` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `app_faqs` WRITE;
/*!40000 ALTER TABLE `app_faqs` DISABLE KEYS */;

INSERT INTO `app_faqs` (`idFac`, `tituloFaq`, `respuestaFaq`, `orden`)
VALUES
...
/*!40000 ALTER TABLE `app_faqs` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla app_lista_religiones
# ------------------------------------------------------------
...
INSERT INTO `app_lista_religiones` (`id_religion`, `des_religiones`, `estado`)
VALUES
	(1,'Advaita Vedanta',1),
	(2,'Adventistas',1),
...
# Volcado de tabla app_listado_afp
# ------------------------------------------------------------
...
INSERT INTO `app_listado_afp` (`id_afp`, `des_afp`, `estado`)
VALUES
	(1,'Colpensiones',1),
	(2,'Porvenir',1),
	(3,'Proteccion',1),
...
# Volcado de tabla app_listado_eps
# ------------------------------------------------------------
...
INSERT INTO `app_login` (`idLogin`, `idGeneral`, `tipoLogin`, `usuario`, `clave`, `clave64`, `cambioClave`, `primeraVez`, `verificado`, `estado`)
VALUES
...
LOCK TABLES `app_mails` WRITE;
/*!40000 ALTER TABLE `app_mails` DISABLE KEYS */;

INSERT INTO `app_mails` (`idMail`, `para`, `asunto`, `mensaje`, `estado`, `fechaEnvio`, `ip`)
VALUES
...
/*!40000 ALTER TABLE `app_mails` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla app_modulos
# ------------------------------------------------------------
...
INSERT INTO `app_modulos` (`idModulo`, `idPadre`, `nombreModulo`, `icono`, `urlModulo`, `estado`, `eliminado`, `nombreLargo`)
VALUES
...
INSERT INTO `app_paises` (`ID_PAIS`, `NOMBRE`)
VALUES
	('057','COLOMBIA'),
	('058','VENEZUELA');
...
INSERT INTO `app_perfiles` (`idPerfil`, `nombrePerfil`, `estado`, `eliminado`)
VALUES
...
# Volcado de tabla app_pertenencia_etnica
# ------------------------------------------------------------
...
INSERT INTO `app_pertenencia_etnica` (`id_grupo_etnico`, `grupo_etnia`, `estado`)
VALUES
	(1,'Ind?¡gena',1),
	(2,'ROM (gitano)',1),
...
# Volcado de tabla app_profesiones
# ------------------------------------------------------------
...
INSERT INTO `app_profesiones` (`idProfesion`, `nombreProfesion`, `estado`)
VALUES
	(1,'Ing de Sistemas',1);
...
# Volcado de tabla app_registroslogin
# ------------------------------------------------------------
...
INSERT INTO `app_registroslogin` (`idRegistro`, `idLogin`, `fecha`, `ip`, `disp`, `eliminado`)
VALUES
...
# Volcado de tabla app_rel_perfil_modulo
# ------------------------------------------------------------
...
INSERT INTO `app_rel_perfil_modulo` (`idRelacion`, `idPerfil`, `idModulo`, `ver`, `crear`, `editar`, `borrar`)
VALUES
	(119,1,7,0,0,0,0),
	(120,2,7,0,0,0,0),
	(194,1,6,1,1,1,1),
...
# Volcado de tabla app_rel_personas_empresa
# ------------------------------------------------------------
...
INSERT INTO `app_sexo` (`idSexo`, `nombreSexo`, `estado`)
VALUES
	(1,'Masculino',1),
	(2,'Femenino',1);
...
# Volcado de tabla app_solicitudes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `app_solicitudes`;

CREATE TABLE `app_solicitudes` (
  `idSolicitud` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `app_solicitudes` WRITE;
/*!40000 ALTER TABLE `app_solicitudes` DISABLE KEYS */;

INSERT INTO `app_solicitudes` (`idSolicitud`, `idEmpleado`, `idEmpresa`, `mes`, `ano`, `monto`, `montoConInteres`, `valorInteres`, `interes`, `idEntidad`, `tipoCuenta`, `nroCuenta`, `idMotivo`, `motivo`, `idReembolso`, `fechaSolicitud`, `fechaReembolso`, `estado`, `eliminado`, `ip`, `userAgent`)
VALUES
...
/*!40000 ALTER TABLE `app_solicitudes` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla app_solicitudes_trans
# ------------------------------------------------------------

DROP TABLE IF EXISTS `app_solicitudes_trans`;

CREATE TABLE `app_solicitudes_trans` (
  `idTrans` bigint(11) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `app_solicitudes_trans` WRITE;
/*!40000 ALTER TABLE `app_solicitudes_trans` DISABLE KEYS */;

INSERT INTO `app_solicitudes_trans` (`idTrans`, `idSolicitud`, `idPersona`, `idEmpleado`, `fechaTrans`, `ip`, `userAgent`, `estado`)
VALUES
...
/*!40000 ALTER TABLE `app_solicitudes_trans` ENABLE KEYS */;
UNLOCK TABLES;


# Volcado de tabla app_tipos_doc
# ------------------------------------------------------------
...
INSERT INTO `app_tipos_doc` (`idTipoDoc`, `nombreTipoDoc`, `sigla`, `estado`)
VALUES
...
# Volcado de tabla app_variablesglobales
# ------------------------------------------------------------
...
INSERT INTO `app_variablesglobales` (`id`, `variable`, `valor`)
VALUES
	(1,'Test','10'),
	(2,'_INTERES_COBRO','4'),
